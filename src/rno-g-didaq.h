 ...
 *
 * Both readout shims take the station number, because the DiDAQ -> RNO-G channel
 * permutation they apply is station-dependent (see rno_g_didaq_chanmap() in rno-g.h).
 */
